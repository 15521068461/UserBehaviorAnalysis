...
public final class C3P0Datasource {
	...
	static {
			...
			try {
				...
				throw new BaseError("配置文件信息有误：需要填写整形数字","系统错误",e);
			}
	...
	public static Connection getConnection() {
		try {
			...
			throw new BaseException("error","数据库连接获取不到","系统异常",e);
		}
	}
