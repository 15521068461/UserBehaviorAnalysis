...
public class UUIDUtil {
	...
	/**
	 * 	短8位UUID
	 * 	思想其实借鉴微博短域名的生成方式，但是其重复概率过高，而且每次生成4个，需要随即选取一个。
	...
	//当前应用单例
	private static SNIDWorker idWorker = new SNIDWorker(Long.parseLong(map.get("common.util.snid.workerId")), Long.parseLong(map.get("common.util.snid.datacenterId")));
	/**
	 * 	雪花ID
	 */
	public static long getSNID() {
