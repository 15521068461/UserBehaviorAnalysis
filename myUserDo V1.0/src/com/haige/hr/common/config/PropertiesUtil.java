package com.haige.hr.common.config;
...
public class PropertiesUtil {
	/**
	 * 将配置文件读取为map集合
	 * @param filePath 相对于src或classes根目录的文件路径， /sys.properties...src/sys.properties�?
	 * @return 
	 */
	public static Map<String, String> getProperties(String filePath){
		...
		if (inStream == null) {
			throw new BaseException("fatal","系统错误：PropertiesUtil  "+filePath+"文件不存",
					"系统错误");
		}
		try {
			props.load(inStream);
